...
|:-----------------:|:--------------------------------:|:-----------------:|
|            [OpenAI](https://platform.openai.com/docs/introduction)            |                                         GPT Models accessible via the OpenAI's REST API. `chattr` provides a convenient way to interact with GPT 4, 3.5, and DaVinci 3.                                         |   [Interact with OpenAI GPT models](https://mlverse.github.io/chattr/articles/openai-gpt.html)   |
