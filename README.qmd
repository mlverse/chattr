...
So that the key is always available in your R session, create or add the line to the `.Renviron` file. This file is available in your home directory.
...
-   Select *Tools* in the top menu, and then select *Modify Keyboard Shortcuts* ![](man/figures/readme/keyboard-shortcuts.png){width="600"}

-   Search for the `tidychat` adding by writing "open chat", in the search box <img src="man/figures/readme/addin-find.png" width="500"/>

-   To select a key combination for your shortcut, click on the Shortcut box and then type *press* the key combination in your keyboard. In my case, I chose *Ctrl+Shift+C* ![](man/figures/readme/addin-assign.png){width="500"}
