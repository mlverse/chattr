...
gpt_completion <- function(defaults, prompt) {
  UseMethod("gpt_completion")
}

gpt_completion.tc_model_gpt_3.5_turbo <- function(defaults, prompt) {
...
gpt_completion.tc_model_davinci_3  <- function(defaults, prompt) {
